This module is a fork of the "paypal-ipn" module. 
I've decided to create this because the original repository does not longer exists, and I would like to improve the module and add new features.
Initial version v1.0.0 has the same features of the v3.0.0 from the original paypal-ipn module.
